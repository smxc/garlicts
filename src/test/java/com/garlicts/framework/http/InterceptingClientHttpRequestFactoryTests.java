...
public class InterceptingClientHttpRequestFactoryTests {
	...
	public void basic() throws Exception {
		...
		ClientHttpRequest request = requestFactory.createRequest(new URI("http://www.baidu.com"), HttpMethod.GET);
	...
	private class RequestMock implements ClientHttpRequest {
		...
		@Override
		public ClientHttpResponse executeJson() throws IOException {
