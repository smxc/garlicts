...
import com.garlicts.framework.exception.http.InvalidMediaTypeException;
...
import com.garlicts.framework.util.comparator.CompoundComparator;
...
public class MediaType implements Comparable<MediaType> {
	...
	public MediaType(String type, String subtype, Map<String, String> parameters) {
		...
		if (!CollectionUtil.isEmpty(parameters)) {
			Map<String, String> m = new LinkedHashMap<String, String>(parameters.size());
	 ...
	 * @see <a href="http://tools.ietf.org/html/rfc2616#section-2.2">HTTP 1s.1, section 2.2</a>
	 */
	...
	public static MediaType parseMediaType(String mediaType) {
		...
		String[] parts = StringUtil.tokenizeToStringArray(mediaType, ";");
	...
	public static List<MediaType> parseMediaTypes(String mediaTypes) {
		if (!StringUtil.hasLength(mediaTypes)) {
