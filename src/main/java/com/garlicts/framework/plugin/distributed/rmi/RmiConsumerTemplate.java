...
//			.getLogger(RmiConsumerTemplate.class);
//
...
//	// List中存放RMI地址，如
//	// rmi://127.0.0.1:20001/com.garlicts.test.rmi.HelloServiceImpl
...
//		ZooKeeper zk = null;
//		try {
//			zk = new ZooKeeper(RmiConstant.ZK_CONNECTION_STRING,
//					RmiConstant.ZK_SESSION_TIMEOUT, new Watcher() {
//						@Override
...
//
//		try {
//			List<String> nodeList = zk.getChildren(
//					RmiConstant.ZK_PROVIDER_PATH, new Watcher() {
//						@Override
//						public void process(WatchedEvent event) {
...
//				byte[] data = zk.getData(RmiConstant.ZK_PROVIDER_PATH + "/"
//						+ node, false, null); // 获取 子节点中的数据
...
//							return lookupService(urlList.get(0), key);
//						} else {
//							return lookupService(urlList.get(ThreadLocalRandom
//									.current().nextInt(urlList.size())), key);
//						}
//					} else {
//
