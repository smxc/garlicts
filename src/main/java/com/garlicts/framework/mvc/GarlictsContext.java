...
import com.garlicts.framework.util.CodecUtil;
 ...
 * @since 1.0
 */
public class GarlictsContext {

    /**
     * 使每个线程拥有各自的 DataContext 实例
     */
    private static final ThreadLocal<GarlictsContext> threadLocal = new ThreadLocal<GarlictsContext>();
    ...
    public static void init(HttpServletRequest request, HttpServletResponse response) {
        GarlictsContext garlictsContext = new GarlictsContext();
        garlictsContext.request = request;
        garlictsContext.response = response;
        threadLocal.set(garlictsContext);
    }
    ...
    public static class Response {
         ...
         */
        public static void put(String key, Object value) {
            getResponse().setHeader(key, ConvertUtil.convertToString(value));
        }
    ...
    public static class Cookie {
         ...
         */
        public static void put(String key, Object value) {
            String strValue = CodecUtil.encodeURL(ConvertUtil.convertToString(value));
